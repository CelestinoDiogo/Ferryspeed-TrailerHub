...
const loadStockCheck = async (supabase: SessionSupabase, stockCheckId: string) => {
...
const loadStockCheckItems = async (supabase: SessionSupabase, stockCheckId: string) => {
  const { data, error } = await supabase
