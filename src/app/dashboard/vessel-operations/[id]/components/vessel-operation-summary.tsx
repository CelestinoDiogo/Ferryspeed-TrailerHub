        ...
        <>
          ...
          <div className="rounded-2xl border border-white/10 bg-slate-900/70 p-4 sm:col-span-2 xl:col-span-8">
            <div className="flex flex-wrap gap-2">
              <Link href={`/dashboard/vessel-operations/${operation.id}/summary`} target="_blank" rel="noreferrer" className="rounded-2xl border border-cyan-400/40 bg-cyan-500/15 px-4 py-2 text-sm font-semibold text-cyan-100 hover:bg-cyan-500/25">
                Generate AI Report
              </Link>
